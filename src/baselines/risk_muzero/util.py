# Risk MuZero utilities
#
# Shared helpers used by the Risk MuZero training loop.
#
# Contents
# --------
...
def init_model_and_optim(env, model_init_fn, args):
    ...
    Constructs dummy inputs for all network heads and calls the joint
    ``init_model_fn`` in a single pass.
...
def batch_n_step_bootstrapped_returns(
    ...
    """Stolen from rlax! Thank you rlax! https://github.com/google-deepmind/rlax
...
def get_train_targets(batch, target_params, representation_apply, critic_apply, args):
    ...
    Returns:
        ...
        s_targets:      Target state embeddings for self-consistency loss,
                        shape ``(batch, seq, num_hidden)``.
    """
    ...
    # Note that this works because the first value is always a 1 since our mask starts _after_
