# Graph Sampled-TQL utilities (node-only variant)
#
# Shared helpers used by the graph Sampled-TQL training loop.
#
# Contents
# --------
...
def init_model_and_optim(env, model_init_fn, args):
    ...
    trace the joint init model, then builds an optax optimiser with optional
    linear LR decay.
