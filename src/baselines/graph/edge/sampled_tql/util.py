# Graph Sampled-TQL utilities (edge-featured variant)
#
# Shared helpers used by the graph edge Sampled-TQL training loop.
#
# Contents
# --------
...
def init_model_and_optim(env, model_init_fn, args):
    ...
    Constructs a dummy observation (including edge features) to trace the joint
    init model, then builds an optax optimiser with optional linear LR decay.
